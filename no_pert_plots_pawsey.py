...
#    lighter_rad_cmap = cmocean.tools.lighten(cmo.haline, 0.5)    
    ...
    plt.tight_layout()   
    plt.savefig('plots/qir_m_ir_rad_no_pert.pdf')
    plt.show()
...
def extinct_qir_m_z(df,h):
    ...
    for z in zlist:
        ...
        fig.set_size_inches(8, 8)
        plt.show()
        save_name = "plots/qir_numbercount_z_no_pert_" + str(round(z)) + ".pdf"
    ...
    for z in zlist:
        ...
        fig.set_size_inches(12, 12)
        plt.tight_layout()   
        save_name = 'plots/extinct_qir_m_z_no_pert_' + str(z) + ".pdf"
        plt.savefig(save_name)
        plt.show()
...
def main(model_dir, outdir, redshift_table, subvols, obsdir):
    ...
    file_name = "Shark-SED-eagle-rr14-no-perturbation-eagle-rr14-radio-only"
